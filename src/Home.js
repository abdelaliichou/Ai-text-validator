...
function Home() {
  ...
  const members = [
    ...
    { name: 'Habib TAHAR DJEBBAR', job: 'Senior DevOps enginner', disciption: "Cloud & DevOps engineer specializing in designing scalable infrastructures and deploying microservices, focusing on streamlining processes and enhancing system reliability", img : habibIMG },
